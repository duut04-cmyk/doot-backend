...
export function buildVerificationEmail(input: {
  ...
  const text = [
    `Hi ${recipientName},`,
    "",
    `Use the verification code below to verify your ${appName} account:`,
    "",
    otp,
    "",
      ...
      <tr>
        <td align="center">
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:520px;background:#ffffff;border-radius:8px;padding:32px;">
            <tr>
              <td>
                <p style="margin:0 0 8px;font-size:14px;font-weight:700;letter-spacing:0.04em;text-transform:uppercase;color:#ea580c;">${appName}</p>
                <h1 style="margin:0 0 16px;font-size:22px;line-height:1.3;">Verify your ${appName} account</h1>
                <p style="margin:0 0 16px;font-size:15px;line-height:1.5;">Hi ${escapeHtml(recipientName)},</p>
                <p style="margin:0 0 20px;font-size:15px;line-height:1.5;">Use the verification code below to verify your ${appName} account:</p>
                ...
                <p style="margin:0;font-size:13px;line-height:1.5;color:#6b7280;">If you did not create a ${appName} account, you can safely ignore this email.</p>
              </td>
            </tr>
          </table>
        </td>
